...
# Parámetros por modelo (zoclo ml = Excel del cliente; charolas/regaderas y
# área de lavandería = medidos/estimados del plano — CONFIRMAR).
GEN={
 'Cabernet':  {'zoclo_m':77.69,'zoclo_r':41.42,'urbania_m2':2.28,
               'regaderas':[('P.A.',2.90),('P.A.',2.90)]},   # 2 charolas
 'Merlot':    {'zoclo_m':58.37,'zoclo_r':40.58,'urbania_m2':2.06,
               'regaderas':[('P.A.',2.90),('P.A.',2.90)]},   # 2 charolas
 'Chardonnay':{'zoclo_m':93.00,'zoclo_r':30.61,'urbania_m2':2.54,
               'regaderas':[('P.A.',2.90),('P.A.',2.90),('P.B.',2.75)]}, # 3
}
REG_PERIM=3.30   # ml de muro enchapado por regadera (3 caras ~1.20+0.90+1.20)
...
def reporte(modelo):
    ...
    R.append(('URBANIA WHITE lavandería (0.30x0.45)', f'{g["urbania_m2"]:.2f} m2 -> {up} pzas', 'cajas: definir pzas/caja'))
    nch=len(g['regaderas']); mm2=nch*MALLA_M2_CHAROLA
    R.append(('MALLA LYNDHURST charolas', f'{nch} charolas x 1.5 m2 = {mm2:.2f} m2', 'se surte por m2/tapete'))
